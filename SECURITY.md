...
The public demo is a static portfolio. It does not process passwords, payments, or production user data. Treat any secret, credential, private token, or unpublished personal document committed here as a security incident.
...
- Affected page, asset, dependency, script, or workflow.
- Reproduction steps using public demo data only.
- Potential impact.
...
- Confirmed dependency, deployment, or personal-data exposure issues are prioritized before content updates.
...
- Findings that require modifying a user's local browser or device outside the portfolio.
